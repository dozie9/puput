...
def entry_url(context, entry, blog_page):
    return urls.get_entry_url(entry, blog_page.page_ptr, Site.find_for_request(context['request']).root_page)
...
def feeds_url(context, blog_page):
    return urls.get_feeds_url(blog_page.page_ptr, Site.find_for_request(context['request']).root_page)
